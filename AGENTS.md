...
This project is indexed by GitNexus as **chrome-extension-anti-procrastination** (219 symbols, 337 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
